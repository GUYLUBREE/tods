...
\`\`\`${lang == 'en' ? 'bahasa yang anda gunakan adalah bahasa inggris, ketik ' + prf + 'changelang untuk mengganti ke bahasa indonesia' : 'the language you use is Indonesian, type ' + prf + 'changelang to change to english'}\`\`\`
          `
                const button = {
                    ...
                    description: str,
                    sections: [{
                        title: lang == 'id' ? "Menu LainNya!!!" : "more features!!!",
                        rows: [{
                                title: prf + 'menu',
                                rowId: "menu"
                            }
                        ...
                        rows: [{
                                title: prf + 'search',
                                description: lang == 'id' ? "Mencari Partner" : "Looking for Partner ",
                                rowId: "search"
                            },
                            {
                                title: prf + 'skip',
                                description: lang == 'id' ? "Skip Chat " : "Skip Chat",
                                rowId: "skip"
                            },
                            {
                                title: prf + 'stop',
                                description: lang == 'id' ? "Keluar Dari Anon Chat " : "out of Anon Chat",
                                rowId: "stop"
                                }
                                ]
                            },
                            {
                            	title: lang == 'id' ? "Mengirim Kontak Kamu Ke User Chat" : "send your contacts to User Chat",
                        rows: [{
                                title: prf + 'sendprofile',
                                description: lang == 'id' ? "Hati - Hati Dalam Mengirim Kontak !!" : "Be Careful In Sending Contacts !!",
                                rowId: "sendprofile"
                                }
                                ]
                            },
                            {
                            	title: lang == 'id' ? "Laporkan Bug Anda" : "Report Your Bug",
                        rows: [{
                                title: prf + 'bug',
                                description: lang == 'id' ? "Laporkan Bug Anda Kepada Pemilik Bot ini !!" : "Report Your Bug To The Owner of This Bot!!",
                                rowId: "bug"
                                }
                                ]
                            },
                            {
                            	title: lang == 'id' ? "Kontak Pemilik Kami !" : "Contact Our Owner !",
                        rows: [{
                                title: prf + 'owner',
                                rowId: "owner"
                            },
                    ...
                    {
                      title: lang == 'id' ? "Mengubah Bahasa !!" : "change language !!",
                        rows: [{
        title: prf + 'changelang',
        description: lang == 'id' ? "Tekan Untuk Mengubah Bahasa" : "press to change language",
                                rowId: "changelang"
                            }
                            ]
                            }],
            ...
            case prf + 'search':
                if (!isMatched(sender).status) {
                    ...
                    const buttonMessage = {
                        ...
                        footerText: 'Follow my IG Owner @Kahfz_13',
                        buttons: [
                            {
                                buttonId: prf + 'stop',
                                buttonText: {
